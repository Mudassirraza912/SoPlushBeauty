                    ...
                    <Image source={require("../../../assets/lockopen.png")} style={{ height: 20, width: 15 }} /> 
                        ...
                        <Input secureTextEntry={true} style={{fontSize:15}} onChangeText={(e) => {this.setState({currentPass:e})}} placeholder="Current Password" />
                                    ...
                                    <Item error={currPassErr} >
                                        ...
                                        <Input style={{ width: '100%', fontSize: 15 }} onBlur={() => this.checkField("currPassword")} onChangeText={(e) => { this.setState({ currentPass: e }) }} placeholder="Current Password" secureTextEntry={true} />
                                    </Item>
                                    ...
                                    <Item error={newPassErr} >
                                        ...
                                        {/* <Label>Password</Label> */}
                                        <Input style={{ width: '100%', fontSize: 15 }} onBlur={() => this.checkField("newPass")} onChangeText={(e) => { this.setState({ newPass: e }) }} placeholder="New Password" secureTextEntry={true} />
                                    </Item>
                                    ...
                                    <Item error={confirmPassErr} >
                                        ...
                                        {/* <Label>Password</Label> */}
                                        <Input style={{ width: '100%', fontSize: 15 }} onBlur={() => this.checkField("confirmPass")} onChangeText={(e) => { this.setState({ confirmPass: e }) }} placeholder="Confirm Password" secureTextEntry={true} />
                                    </Item>
